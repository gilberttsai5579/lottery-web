# CLAUDE.md - lottery web

> **Documentation Version**: 1.0  
> **Last Updated**: 2025-08-02  
> **Project**: lottery web  
> **Description**: Threads/Instagram 抽獎網頁專案 - 基於 Flask 的網頁應用程式，支援從 Threads 和 Instagram 貼文留言中進行抽獎  
...
└── output/                # Generated output files (Excel exports)
```

## 🏗️ PROJECT OVERVIEW

**lottery web** - A Flask-based web application for conducting lotteries from Threads and Instagram post comments. Supports three different lottery modes with web scraping capabilities and Excel export functionality.
...
Write(file_path="new_scraper.py", content="...")
```

### ✅ CORRECT APPROACH (Prevents Technical Debt):
```bash
# 1. SEARCH FIRST
Grep(pattern="scraper.*implementation", include="*.py")
# 2. READ EXISTING FILES  
Read(file_path="src/main/python/services/scrapers/base_scraper.py")
# 3. EXTEND EXISTING FUNCTIONALITY
Edit(file_path="src/main/python/services/scrapers/base_scraper.py", old_string="...", new_string="...")
```
